...
urlpatterns = [
    ...
    path('peruca/<int:id>/excluir', views.excluir_peruca, name='excluir_peruca'),
    path('minhas_solicitacoes/', views.minhas_solicitacoes, name='minhas_solicitacoes'),
    path('solicitacao/solicitar', views.fazer_solicitacao, name='fazer_solicitacao'),
    ...
    path('solicitacao/<int:id>/excluir', views.deletar_solicitacao, name="deletar_solicitacao")
] 